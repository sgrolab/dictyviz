...
bsub -K -J "remove_cell_shadows" -n 12 -gpu "num=1" -q gpu_a100 -W 08:00 python3 remove_cell_shadows.py "$RESULTS_DIR" "$START_Z" "$END_Z"

# Submit the tracking job to the cluster
bsub -J "segment_track_rocks" -n 16 -W 24:00 python3 segment_track_rocks_3d.py "$RESULTS_DIR" "$START_Z" "$END_Z"
